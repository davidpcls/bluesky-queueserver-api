...
from bluesky_queueserver_api._defaults import (
    default_http_server_uri,
    default_user_group,
)
from bluesky_queueserver_api.comm_threads import (
    ReManagerComm_HTTP_Threads,
    ReManagerComm_ZMQ_Threads,
)
...
def test_ReManagerComm_ZMQ_Threads_02(monkeypatch, re_manager_cmd):  # noqa: F811
    ...
    RM = ReManagerComm_ZMQ_Threads(
        zmq_control_addr=zmq_server_addr, zmq_public_key=public_key
    )
