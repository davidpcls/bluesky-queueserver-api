...
You can consume this package from a Pixi project through
``[pypi-dependencies]``.
...
.. code-block:: toml
        ...
        [pypi-dependencies]
        bluesky-queueserver-api = { path = "../bluesky-queueserver-api", editable = true }

Then install/update the environment:

.. code-block:: bash

        pixi install

Git dependency pinned to a revision:

.. code-block:: toml

        [pypi-dependencies]
        bluesky-queueserver-api = { git = "https://github.com/bluesky/bluesky-queueserver-api", rev = "<commit-or-tag>" }
